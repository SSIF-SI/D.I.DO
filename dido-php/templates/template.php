...
<!-- MetisMenu CSS -->
<link href="<?=SB_ADMIN_2?>vendor/metisMenu/metisMenu.min.css"
	rel="stylesheet">
...
<!-- Custom Fonts -->
<link href="<?=SB_ADMIN_2?>vendor/font-awesome/css/font-awesome.min.css"
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?=HTTP_ROOT?>"> <img
					src="https://raw.githubusercontent.com/liparig/D.I.DO/Logo/LOGO%20DIDO%20fede.png"
					style="height: 100%;" />
				</a>
			</div>
			<!-- /.navbar-header -->
	...
	<script
		src="<?=SB_ADMIN_2?>vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
	<script
	...
	<script
		src="<?=SB_ADMIN_2?>vendor/datatables/js/jquery.dataTables.min.js"></script>
	<script
		src="<?=SB_ADMIN_2?>vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
	<script
		src="<?=SB_ADMIN_2?>vendor/datatables-responsive/dataTables.responsive.js"></script>
	
	<?php if(defined("KARTIK_FILEINPUT")):?>
    <script
		src="<?=LIB_PATH?>kartik-v-bootstrap-fileinput/js/fileinput.min.js"></script>
	<script
		src="<?=LIB_PATH?>kartik-v-bootstrap-fileinput/js/locales/it.js"></script>
	<script>
	    $(".file").fileinput({
	        language: "it",
	    });
