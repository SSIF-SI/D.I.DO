	                        ...
	                        <div class="panel-body">
	                            ...
	                            <div class="tab-content">
	                                <div class="tab-pane active" id="elenco-firmatari">
	                                    ...
	                                    <div>
	                                  	<!--<a class="btn btn-primary" href="<?=BUSINESS_HTTP_PATH."editSigner.php"?>"><span class="glyphicon glyphicon-plus"></span> Nuovo firmatario</a> -->
                                           	<a class="btn btn-primary mymodal" href="<?=BUSINESS_HTTP_PATH.basename($_SERVER['PHP_SELF'])?>"><span class="fa fa-plus fa-1x fa-fw"></span> Nuovo Firmatario</a>
	                                    </div>
				                    	<?=$signers['all']?>
				                     </div>
					                <div class="tab-pane" id="firmatari-fissi">
	                                    ...
	                                    <div>
				                    		<a class="btn btn-primary" href="<?=BUSINESS_HTTP_PATH."editSigner.php?list=fixed"?>"><span class="fa fa-plus fa-1x fa-fw"></span> Aggiungi firmatario fisso</a>
				                    	</div>
				                    	<?=$signers['fixed']?>
	                                </div>
					                <div class="tab-pane" id="firmatari-variabili">
	                                    ...
	                                    <div>
				                    		<a class="btn btn-primary" href="<?=BUSINESS_HTTP_PATH."editSigner.php?list=variable"?>"><span class="fa fa-plus fa-1x fa-fw"></span> Aggiungi firmatario variabile</a>
				                    	</div>
					                	<?=$signers['variable']?>
	                                </div>
					        	</div>
